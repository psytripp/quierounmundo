...
<main>
    <div class="container align-items-md-center" >
        ...
        <table class="table table-bordered table-dark">
            ...
            <tbody>
                <c:forEach var="causas" items="${causas}">
                <tr>
                    <td><c:out value="${causas.getIdCausa()}"/></td>
                    <td><c:out value="${causas.getNombreCausa()}"/></td>
                    <td><c:out value="${causas.getObjetivoCausa()}"/></td>
                    <td><c:out value="${causas.getParticipantesCausa()}"/></td>
                    <td><c:out value="${causas.getSedeCausa()}"/></td>
                    <td><c:out value="${causas.getTelefonoCausa()}"/></td>
                    <td>
                        <spring:url value="/causa/actualizar/${causas.idCausa}" var="actualizarURL"/>
                        <a class="btn btn-info" href="${actualizarURL}" role="button" >ACTUALIZAR</a>
                    </td>
                    <td>
                        <spring:url value="/causa/eliminar/${causas.idCausa}" var="eliminarURL"/>
